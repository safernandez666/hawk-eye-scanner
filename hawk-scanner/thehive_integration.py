...
class TheHiveIntegration:
    ...
    def test_connection(self) -> bool:
        """Prueba la conexión con TheHive y verifica autenticación"""
        try:
            # Primero verificamos que el servidor responda
            response = requests.get(
            ...
            # Luego verificamos que la API key funcione haciendo una llamada autenticada
            # Usamos listCase con limit=0 para no traer datos, solo verificar auth
            ...
            # 200 = auth OK, 401/403 = auth failed
