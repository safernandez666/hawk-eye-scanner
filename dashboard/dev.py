...
os.environ.setdefault('THEHIVE_ENABLED', 'false')
os.environ.setdefault('THEHIVE_URL', 'http://localhost:9000')
os.environ.setdefault('THEHIVE_API_KEY', '')
...
if __name__ == '__main__':
    ...
    print(f"  TheHive:  {os.environ['THEHIVE_URL']} (enabled={os.environ['THEHIVE_ENABLED']})")
    print(f"  =====================================")
